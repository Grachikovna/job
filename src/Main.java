public class Main {
    public static void main(String[] args) {
        ...
        double mashaDiff = mashaSalaryForYearIncreased - mashaIncreased;
        double denisDiff = denisSalaryForYearIncreased - denisIncreased;
        double kristinaDiff = kristinaSalaryForYearIncreased - kristinaIncreased;
